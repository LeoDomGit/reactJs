                        ...
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="hover-icon">
                                    <a href="img/products/img-9.jpg" className="pop-up">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-product-item">
                                    <figure>
                                        ...
                                        <div className="p-status">new</div>
                                        <div className="hover-icon">
                                            <a href="img/products/img-3.jpg" className="pop-up">
                                                <img src="img/icons/zoom-plus.png" alt="" />
                                            </a>
                                        </div>
                                    </figure>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-product-item">
                                    <figure>
                                        ...
                                        <div className="hover-icon">
                                            <a href="img/products/img-1.jpg" className="pop-up">
                                                <img src="img/icons/zoom-plus.png" alt="" />
                                            </a>
                                        </div>
                                    </figure>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="p-status">new</div>
                                <div className="hover-icon">
                                    <a href="img/products/img-5.jpg" className="pop-up">
                                        <img src="img/icons/zoom-plus.png" alt="" />
                                    </a>
                                </div>
                            </figure>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="hover-icon">
                                    <a href="img/products/img-4.jpg" className="pop-up">
                                        <img src="img/icons/zoom-plus.png" alt="" />
                                    </a>
                                </div>
                            </figure>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="p-status popular">popular</div>
                                <div className="hover-icon">
                                    <a href="img/products/img-8.jpg" className="pop-up">
                                        <img src="img/icons/zoom-plus.png" alt="" />
                                    </a>
                                </div>
                            </figure>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="p-status popular">popular</div>
                                <div className="hover-icon">
                                    <a href="img/products/img-10.jpg" className="pop-up">
                                        <img src="img/icons/zoom-plus.png" alt="" />
                                    </a>
                                </div>
                            </figure>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-product-item">
                                    <figure>
                                        ...
                                        <div className="p-status">new</div>
                                        <div className="hover-icon">
                                            <a href="img/products/img-12.jpg" className="pop-up">
                                                <img src="img/icons/zoom-plus.png" alt="" />
                                            </a>
                                        </div>
                                    </figure>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-product-item">
                                    <figure>
                                        ...
                                        <div className="hover-icon">
                                            <a href="img/products/img-15.jpg" className="pop-up">
                                                <img src="img/icons/zoom-plus.png" alt="" />
                                            </a>
                                        </div>
                                    </figure>
                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="single-product-item">
                            <figure>
                                ...
                                <div className="p-status">new</div>
                                <div className="hover-icon">
                                    <a href="img/products/img-13.jpg" className="pop-up">
                                        <img src="img/icons/zoom-plus.png" alt="" />
                                    </a>
                                </div>
                            </figure>
